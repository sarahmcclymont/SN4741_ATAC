...
# Update: To normalize by read count for IGV display, can't use toTDF command, have to use `count` from the bam files. Repeat and use this for display actually. 
...
for file in *.bam; do
  ~/Software/IGV_2.15.2/igvtools count $file ${file%bam}.count.tdf mm10
done
